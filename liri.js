...
function movieThis(value) {
	...
	var queryUrl = "http://www.omdbapi.com/?t=" + movieName + "&plot=short&apikey=7267b2d1";
...
switch (action) {
	...
	default:
		console.log("You must pass an action [spotify-this-song, movie-this, do-what-it-says] and a value");
